                                ...
                                menu.map(item => (
                                    <li key={item.id}>
                                        <NavLink to={item.link === "overview" ? "/" : `/${item.link}`}
                                            ...
                                            style={{
                                                backgroundImage: (((hoverId === item.id) ||  location.pathname.startsWith(`/${item.link}`) || (location.pathname == `/${item.link}`)) || (item.link === "overview" && location.pathname == "/")) ? `url(${noice})` : "none",
                                            ...
                                            ${((hoverId === item.id) ||  location.pathname.startsWith(`/${item.link}`) || (location.pathname == `/${item.link}`) || (item.link === "overview" && location.pathname == "/")) && "shadow-[inset_0_1px_18px_2px_#D2EAFF,_0_42px_107px_0_#57b1ff53,_0_24.72px_32.26px_0_#57b1ff2f,_0_10.27px_13.4px_0_#57b1ff38,_0_3.71px_4.85px_0_#57b1ff2c] bg-gradient-to-b from-[#152252] to-[#111B3C] border-b-1 border-white"}
                                            `}
